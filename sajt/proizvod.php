            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <form action="proizvod.php?id=<?= $id?>" method="post">
                        <input type="text" name="ime" placeholder="Unesite ime" value="<?= login()?$_SESSION['podaci']:""?>" required><br><br>
                ...
                <?php
                    if(isset($_GET['id'])){
                        ...
                        $upit="SELECT * FROM komentari WHERE idProizvoda={$id} and odobren=1 ORDER BY id DESC";
                        $rez=$db->query($upit);
                        if($db->num_rows($rez)==0){
